...
decimal velocidadeVolta, tempoMaisRapido = 0, tempoMaisLento = 0, somaTempos = 0;
...
Console.WriteLine("O pilotp: " + pilotoMaisRapido + "foi o mais rápido, tempo " + tempoMaisRapido);
Console.WriteLine("O piloto " + pilotoMaisLento + " foi o mais leno, tempo: " + tempoMaisLento);
Console.WriteLine(" a média do tempo dos pilotos foi: " + (somaTempos / quantidadePilotos));
